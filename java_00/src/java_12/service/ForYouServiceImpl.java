...
public class ForYouServiceImpl implements ForYouService {
	...
	public void solutionBook() {
		...
		// 고민해결책의 답 가져오기
//		ArrayList<String> solBook = forYouDAO.selectSolutionBook();
//		
//		int selectPage = (int) (Math.random()*solBook.size());
//		
//		String result = solBook.get(selectPage);
	...
	public void fortuneBook() {
		...
		// 고민해결책의 답 가져오기
//		ArrayList<String> forBook = forYouDAO.selectFortuneBook();
//		
//		int  selectPage = (int)(Math.random()*forBook.size());
//		
//		String result = forBook.get(selectPage);
